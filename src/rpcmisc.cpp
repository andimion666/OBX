...
// Copyright (c) 2017-2018 The Orbox developers
...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total Orbox balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zOBXsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zOBX denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zOBX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zOBX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zOBX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zOBX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zOBX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zOBX denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zOBX denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zOBX denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in Orbox/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in Orbox/kb\n"
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zOrboxObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zOrboxObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zOBXsupply", zOrboxObj));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"Orboxaddress\"\n"
            "\nReturn information about the given Orbox address.\n"
            "\nArguments:\n"
            "1. \"Orboxaddress\"     (string, required) The Orbox address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"Orboxaddress\", (string) The Orbox address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Orbox address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are Orbox addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) Orbox address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"Orboxaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"Orboxaddress\"  (string, required) The Orbox address to use for the signature.\n"
