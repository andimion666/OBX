                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Orbox from zOrbox"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zOrbox"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zOrbox));
