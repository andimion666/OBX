                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Orbox Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Orbox address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Orbox: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOBX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Orbox Core"), this);
    aboutAction->setStatusTip(tr("Show information about Orbox Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Orbox"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Orbox addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Orbox addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagOrboxtic information"));
    ...
    openAction->setStatusTip(tr("Open a Orbox: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Orbox Core help message to get a list with possible Orbox command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Orbox Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Orbox network", "", count));
}
...
{
    QString strTitle = tr("Orbox Core"); // default title
...
/** Creates context menu, its actions, and Orboxs up all the relevant signals for mouse events. */
