...
/** Utility functions used by the Orbox Qt UI.
 */
namespace GUIUtil
{
...
// Render Orbox addresses in moOrboxpace font
...
// Parse "Orbox:" URI into recipient object, return true on successful parsing
