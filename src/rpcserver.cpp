...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Orbox features */
        {"Orbox", "masternode", &masternode, true, true, false},
        {"Orbox", "listmasternodes", &listmasternodes, true, true, false},
        {"Orbox", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Orbox", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Orbox", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Orbox", "masternodedebug", &masternodedebug, true, true, false},
        {"Orbox", "startmasternode", &startmasternode, true, true, false},
        {"Orbox", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Orbox", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Orbox", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Orbox", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Orbox", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Orbox", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Orbox", "mnbudget", &mnbudget, true, true, false},
        {"Orbox", "preparebudget", &preparebudget, true, true, false},
        {"Orbox", "submitbudget", &submitbudget, true, true, false},
        {"Orbox", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Orbox", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Orbox", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Orbox", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Orbox", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Orbox", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Orbox", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Orbox", "checkbudgets", &checkbudgets, true, true, false},
        {"Orbox", "mnsync", &mnsync, true, true, false},
        {"Orbox", "spork", &spork, true, true, false},
        {"Orbox", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Orbox", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Orboxd, or the -server option to Orbox-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Orbox-cli " + methodname + " " + args + "\n";
}
