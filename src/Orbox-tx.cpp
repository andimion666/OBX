...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Orbox Core Orbox-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Orbox-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Orbox transaction") + "\n" +
                               "  Orbox-tx [options] -create [commands]   " + _("Create hex-encoded Orbox transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Orbox transaction
