Contributing to Orbox Core
============================

The Orbox Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Orbox Core project, and is not to be
confused with overall Orbox Network Protocol consensus changes.

Whether a pull request is merged into Orbox Core rests with the project merge
...
Patches that change Orbox consensus rules are considerably more involved than
...
Where a patch set proposes to change the Orbox consensus, it must have been
...
The project leader is the release manager for each Orbox Core release.
