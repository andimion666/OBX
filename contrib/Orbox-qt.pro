...
RESOURCES += src/qt/Orbox.qrc src/qt/Orbox_locale.qrc

TRANSLATIONS += src/qt/locale/Orbox_bg.ts \
                src/qt/locale/Orbox_de.ts \
                src/qt/locale/Orbox_en.ts \
                src/qt/locale/Orbox_es.ts \
                src/qt/locale/Orbox_fi.ts \
                src/qt/locale/Orbox_fr.ts \
                src/qt/locale/Orbox_it.ts \
                src/qt/locale/Orbox_ja.ts \
                src/qt/locale/Orbox_pl.ts \
                src/qt/locale/Orbox_pt.ts \
                src/qt/locale/Orbox_ru.ts \
                src/qt/locale/Orbox_sk.ts \
                src/qt/locale/Orbox_sv.ts \
                src/qt/locale/Orbox_vi.ts \
                src/qt/locale/Orbox_zh_CN.ts \
                src/qt/locale/Orbox_zh_TW.ts
